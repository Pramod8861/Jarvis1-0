...
recognition.onstart = function () {
    ...
    clearTimeout(recognitionTimer); // Clear any previous timer
};
...
recognition.onspeechend = function () {
    ...
    recognitionTimer = setTimeout(() => {
        if (content.textContent === 'You were quiet for a while so voice recognition turned itself off.') {
            content.textContent = 'Click here to speak';
        }
    }, 1000); // Delay before showing "Click here to speak"
};
