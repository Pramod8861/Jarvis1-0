...
const startJARVISButton = document.getElementById('start-jarvis');
const body = document.body;



startJARVISButton.addEventListener('click', () => {
    interactionPrompt.style.display = 'none';
    body.classList.remove('blurred'); // Remove blur effect
    initJARVIS(); // Start JARVIS
});
...
window.addEventListener('load', () => {
    showInteractionPrompt(); // Show prompt on page load
});
