...
btn.addEventListener('click', () => {
    ...
    recognition.onresult = async function (event) {
        ...
        if (transcript.toLowerCase().includes('open')) {
            ...
            openWebsite(url);
        } else if (transcript.toLowerCase().includes('hello jarvis')) {
        ...
        } else if (transcript.includes('what is') || transcript.includes('who is') || transcript.includes('what are')) {
            window.open(`https://www.google.com/search?q=${transcript.replace(" ", "+")}`, "_blank");
            await speak("This is what I found on the internet regarding " + transcript);
        } else if (transcript.includes('wikipedia')) {
            window.open(`https://en.wikipedia.org/wiki/${transcript.replace("wikipedia", "")}`, "_blank"); 
            await speak("This is what I found on Wikipedia regarding " + transcript);
        ...
        } else if (transcript.includes('find on youtube')) {
            const songName = transcript.replace('find on youtube', '').trim();
            ...
            window.open(`https://www.google.com/search?q=${transcript.replace(" ", "+")}`, "_blank");
            await speak("I found some information for " + transcript + " on Google");
        }
    };
